...
public class RegistrationIntentService extends IntentService {
    ...
    private static final String user_id = "1155071415";
    ...
    private void post(String message) {
        httptasktoken httptoken = new httptasktoken();
        httptoken.HttpPostUrltoken("http://54.238.173.183/iems5722/submit_push_token", message, user_id);
    }
